...
"             kstep <me@kstep.me>
"             Modified by Oren Shklarsky <orenshk at gmail dot com>
"
"============================================================================
function! SyntaxCheckers_python_my_flake8_IsAvailable()
...
function! SyntaxCheckers_python_my_flake8_GetLocList()
    let makeprg = syntastic#makeprg#build({
                \ 'exe': 'flake8 --ignore=E203,E302,E127',
                \ 'subchecker': 'flake8' })
